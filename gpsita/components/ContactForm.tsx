  ...
  return (
    <section id="contact" className="py-20">
      <div className="container mx-auto px-6 xl:px-28">
        <div className="bg-[#0c1b2d] border-2 border-[#192a44] rounded-2xl p-8 md:p-16 max-w-4xl mx-auto text-center transition-shadow duration-300 shadow-[-4px_-4px_50px_0px_rgba(0,64,153,0.5),_4px_4px_50px_0px_rgba(0,122,82,0.6)] hover:shadow-[0px_0px_5px_0px_rgba(0,64,153,0.7),_0px_0px_5px_0px_rgba(0,122,82,0.8)]">
